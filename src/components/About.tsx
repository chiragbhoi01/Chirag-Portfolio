      ...
      <div className="flex flex-col items-center w-full mt-5">
        ...
        <div className="flex flex-col md:flex-row w-full">
          ...
          <div className="w-full md:w-[50%] flex flex-col justify-center p-4">
            ...
            <p className="text-lg">
              I'm Chirag Bhoi, a Frontend Developer based in Udaipur, Rajasthan.
              With a strong foundation in React.js, TypeScript, and Tailwind
              CSS, I create responsive and accessible web applications that
              prioritize user experience. My journey in web development is
              driven by a passion for solving problems and building intuitive
