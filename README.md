...
<div align="center">
  ...
  **Full-Stack Driven Frontend Developer** *Building elegant, performant interfaces & scalable backend architectures.*
  ...
  [<img src="https://img.shields.io/badge/Resume-View_PDF-FF5500?style=for-the-badge&logo=adobe-acrobat-reader&logoColor=white" />](https://drive.google.com/file/d/1gA11cq86z5Mms0PyGe0up6nNZL59mx2L/view?usp=drive_link)
...
| :--- | :--- | :--- | :--- |
| **RAJMAHAL UDAIPUR** | **Full-Stack E-commerce** rental platform with secure Admin CMS, JWT auth, and role-based access. | Next.js 14, Node, Mongo, TS | [Live Demo](https://chirag-rajmahaludaipur.vercel.app) • [Code](https://github.com/fullstackproject) |
| **Miss Gypsy** | **Jewelry E-commerce** with dynamic product filtering. Achieved **95% Lighthouse** performance score. | React, Tailwind, Firebase | [Live Demo](https://chirag-shopmissgypsy.vercel.app) • [Code](https://github.com/chiragbhoi01/Ecommerce-jewellery-website) |
| **Personal Portfolio** | **SPA Portfolio** with real-time GitHub stats, dynamic theming, and Framer Motion animations. | Next.js, Shadcn, GitHub API | [Live Demo](https://chiragbhoimarshal.netlify.app/) • [Code](https://github.com/chiragbhoi01/Chirag-Portfolio) |
...
*Feb 2024 – Present | Udaipur, India* * Applied analytical skills to process large datasets using Excel/Google Sheets with **99% accuracy**.
...
*Jul 2024 – Aug 2024 | Remote* * Built responsive, accessible web components using **React.js, TypeScript, and Tailwind CSS**.
...
* **Master of Computer Applications (MCA)** *Manipal University Jaipur (Mar 2024 – Mar 2026)*
* **Bachelor of Science (B.Sc.)** *Janardan Rai Nagar Rajasthan Vidyapeeth (Aug 2020 – Jul 2023)*
